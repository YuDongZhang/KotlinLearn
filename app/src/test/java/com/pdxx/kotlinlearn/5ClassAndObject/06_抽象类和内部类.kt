...
class Test61 {
    ...
    fun test1() {
        ...
        println(mTestAbstarctB.TAG)
        println(mTestAbstarctB.myName)
    }
...
class Test62 {
    ...
    fun test() {
        // 若要实现抽象类的实例化，需要依靠子类采用向上转型的方式处理。
        val mLanauage: Lanauage2 = TestAbstarctC()
    }
}
